...
//   1. Wszystkie elementy galerii powinny być dodawane do DOM podczas jednej operacji.
//   2. Ulepsz galerię używając flexboxów lub gridów poprzez klasy CSS.
...
const item = images.reduce((temp, image) =>
    (temp += `<li><img  src=${image.url} alt=${image.alt} width="100%"></li>`),"");

pictures.insertAdjacentHTML("afterbegin", item);
